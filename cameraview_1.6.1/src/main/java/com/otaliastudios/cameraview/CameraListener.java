...
public abstract class CameraListener {
     ...
     * <p>
     * If planning to get a bitmap, you can use
     * {@link CameraUtils#decodeBitmap(byte[], CameraUtils.BitmapCallback)}
     ...
     * and the autofocus is trying to focus around that area. This can be used to draw things on
     * screen.
     ...
     * @param point      coordinates with respect to CameraView.getWidth() and CameraView
     *                   .getHeight()
     */
    @UiThread
