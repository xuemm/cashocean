...
public class CameraUtils {
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public static void decodeBitmap(final byte[] source, final int maxWidth, final int maxHeight,
    ...
    public static Bitmap decodeBitmap(byte[] source, int maxWidth, int maxHeight,
        ...
        try {
            ...
            Integer exifOrientation = exif.getAttributeInt(ExifInterface.TAG_ORIENTATION,
