...
import com.jike.cashocean.model.TravelingEntity;
import com.jike.cashocean.model.TravelingEntityComparator;
...
public class ModelUtil {
    ...
    // 广告数据
    public static List<HomeListData.DataBean.DatasBean.BannerListBean> getBannerData() {
        List<HomeListData.DataBean.DatasBean.BannerListBean> adList = new ArrayList<>();
        HomeListData.DataBean.DatasBean.BannerListBean bannerListBean = new HomeListData.DataBean.DatasBean.BannerListBean();
        bannerListBean.setBanner_image("http://img2.imgtn.bdimg.com/it/u=2850936076,2080165544&fm=206&gp=0.jpg");
        adList.add(bannerListBean);
        return adList;
    }
