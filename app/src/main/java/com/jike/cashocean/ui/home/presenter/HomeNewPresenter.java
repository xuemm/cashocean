...
public class HomeNewPresenter extends BasePresenter<HomeNewFragment> implements HomeContract.Presentere {
    private ApiHome _apiHome;
    private Context _context;

    @Inject
    public HomeNewPresenter(ApiHome apiHome, Context context) {
